...
def run():
    ...
    st.title(_("국가 예비타당성조사 종합평가(AHP) 시스템", "Preliminary Feasibility Study AHP System"))
    st.write(_("기획재정부 및 KDI 표준 지침을 준수하는 공공투자사업 AHP 종합 평가 모듈입니다.", "AHP comprehensive evaluation module for public investment projects in compliance with MoEF & KDI standard guidelines."))
    st.write("")
