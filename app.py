...
def get_portone_payment_html(user_id, plan_name="정식 사용자", amount=500000, months=2, inner_html="", is_best=False):
    ...
    if is_event_active:
        ...
        <div id="event-container" style="margin-top: auto; margin-bottom: 6px; padding: 6px 8px; background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border: 1px dashed #0284c7; border-radius: 6px; font-size: 0.72rem; text-align: left; line-height: 1.2; height: auto; overflow: hidden;">
            ...
            <div id="event-inputs" style="display: none; flex-direction: column; gap: 4px; background: white; padding: 6px; border-radius: 4px; border: 1px solid #e2e8f0; margin-top: 4px; width: 100%; box-sizing: border-box;">
