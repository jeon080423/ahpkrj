...
def get_fee_info_text():
  ...
  <ul style="margin: 0; padding-left: 20px; margin-bottom: 8px;">
    ...
    <li style="margin-bottom: 2px;"><b>정식 사용자</b>: 50만원 (3개월)<br><span style="font-size: 0.85rem; color: #555; display: inline-block; padding-left: 20px; text-indent: -20px; margin-top: 2px;">(AHP 온라인 설문 셋팅 대행 요청시 5만원 추가)</span></li>
  </ul>
