...
def create_docx():
    ...
    img1 = os.path.join(output_dir, "screenshot1.png")
    img2 = os.path.join(output_dir, "screenshot2.png")
    doc_path = os.path.join(output_dir, "AHP 상대비료 온라인 설문 작성 및 배포 무료_최종.docx")
